...
class TestCreateOrder:
    ...
    def test_create_order(self, order_page, order_data):
        (order_page
         .enter_first_name(order_data.first_name)
         .enter_last_name(order_data.last_name)
         .enter_addres_delivery(order_data.address_delivery)
         .select_metro_station(order_data.metro_station.value)
         .enter_phone(order_data.phone)
